...
AUF_CREDIT_ProcessV.17.1.16.py:11-04-2024[Rejectting special character embo name]
                        ...
                        for line_acc in infile_acc:
                            ...
                            if name_check == False:
                                with open("Special_Character_Records.csv",'a') as special_chr_rec:
                                    special_chr_rec.write(print_embo_name +' has special character in EMbo name acoount number details is '+account_number_acc+'\n') 
                            else:
