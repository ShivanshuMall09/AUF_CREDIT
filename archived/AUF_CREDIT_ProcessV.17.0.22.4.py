...
AUF_CREDIT_ProcessV.17.1.22.4.py:30-05-2024[Trasfering the priority pass file, processing log,special character file ,AUF_File_DupeCheck file and data allocation file automatically ]
...
try:
    print('Version: AUF_CREDIT_ProcessV.17.1.22.4')
        ...
        def excel_convertor(name_ff):
            ...
            if name_ff.__contains__('Zenith_Plus'):
                ...
                if Path(name_ff).is_file():
                    ...
                    s_no = 0
                    with open(name_ff, "r") as ff, open(name_ff[2:], "w") as foutfile:
                        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date|Card Type|Expiry Date"+'\n')
                        contents = ff.readlines()
                        # sorting using our custom logic
                        contents.sort(key=my_sort_ff_courier)
                        contents.sort(key=my_sort_ff_cardtype)
        ...
        def excel_convertor_replace(name_ff):
            ...
            if name_ff.__contains__('Zenith_Plus'):
                ...
                if Path(name_ff).is_file():
                    ...
                    s_no = 0
                    with open(name_ff, "r") as ff, open(name_ff[2:], "w") as foutfile:
                        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|CardType|Expiry Date"+'\n')
                        contents = ff.readlines()
                        # sorting using our custom logic
                        contents.sort(key=my_sort_ff_courier)
                        contents.sort(key=my_sort_ff_cardtype)
...
#=============================================File-Prcocessing starts=============================================   
        ...
        # =============================================================================
                                ...
                                try: 
                                    if totol_card_count == 1 or product.__contains__("Zenith_Plus") or product.__contains__("LIT"):
    ...
    # =============================================================================
                                ...
                                if logo_acc != '306':
                                    if ((c_bin_acc == '465523_1' and card_holder_type_acc=='1') or c_bin_acc == '457036'):
                                ...
                                if product == 'Zenith_Plus':
                                    ...
                                    if ((card_holder_type_acc == '1') and (card_action_code=='3' or card_action_code== 'L')):
                                        ...
                                        with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+'.txt', 'a') as ff_file_acc:
                                            ff_file_acc.write(file_credit_card_ff_acc_primary +file_credit_card_ff_acc_2_primary+file_credit_card_ff_acc_3_primary_replace+'|'+salutation_acc+' ' +print_card_holder_name_acc+'|'+ (pp_exp_date_acc[0:2]+'/'+str(int(pp_exp_date_acc[2:4])+3)) +'|Pri_Replace|'+exp_date_acc_ff+'\n')
                                        ff_file_acc.close()
                                        
                                        with open('xxAUC_EM_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+'.txt', 'a') as em_file_acc:
                                        ...
                                        with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+' - Add-On-Card.txt', 'a') as ff_addonfile_acc:
                                            ff_addonfile_acc.write(file_credit_card_ff_acc_addon+file_credit_card_ff_acc_2_addon+file_credit_card_ff_acc_3_addon_replace+'|'+salutation_acc+' ' +print_card_holder_name_acc+'|'+ (pp_exp_date_acc[0:2]+'/'+str(int(pp_exp_date_acc[2:4])+3)) +'|AddOn_Replace|'+exp_date_acc_ff+'\n')
                                        ...
                                        with open('xxAUF_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+'.txt', 'a') as ff_file_acc:
                                            ff_file_acc.write(file_credit_card_ff_acc_primary +file_credit_card_ff_acc_2_primary+file_credit_card_ff_acc_3_primary+'|'+salutation_acc+' ' +print_card_holder_name_acc+'|'+ (pp_exp_date_acc[0:2]+'/'+str(int(pp_exp_date_acc[2:4])+3)) +'|Pri|'+exp_date_acc_ff+'\n')
                                        ff_file_acc.close()
                                        ...
                                        with open('xxAUF_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+' - Add-On-Card.txt'+'.txt', 'a') as ff_addonfile_acc:
                                            ff_addonfile_acc.write(file_credit_card_ff_acc_addon+file_credit_card_ff_acc_2_addon+file_credit_card_ff_acc_3_addon+'|'+salutation_acc+' ' +print_card_holder_name_acc+'|'+ (pp_exp_date_acc[0:2]+'/'+str(int(pp_exp_date_acc[2:4])+3)) +'|Add-On|'+exp_date_acc_ff+'\n')
                                        ff_addonfile_acc.close()
                                    ...
                                    if ((card_holder_type_acc == '1') and (card_action_code=='3' or card_action_code== 'L')):
                                        ...
                                        with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+'.txt', 'a') as ff_file_acc:
                                            ff_file_acc.write(file_credit_card_ff_acc_primary +file_credit_card_ff_acc_2_primary+file_credit_card_ff_acc_3_primary_replace+'|Pri_Replace|'+exp_date_acc_ff+'\n')
                                        ff_file_acc.close()
                                        ...
                                        with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+' - Add-On-Card.txt', 'a') as ff_addonfile_acc:
                                            ff_addonfile_acc.write(file_credit_card_ff_acc_addon+file_credit_card_ff_acc_2_addon+file_credit_card_ff_acc_3_addon_replace+'|AddOn_Replace|'+exp_date_acc_ff+'\n')
                                        ff_addonfile_acc.close()
                                        ...
                                        with open('xxAUF_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+'.txt', 'a') as ff_file_acc:
                                            ff_file_acc.write(file_credit_card_ff_acc_primary +file_credit_card_ff_acc_2_primary+file_credit_card_ff_acc_3_primary+'|Pri|'+exp_date_acc_ff+'\n')
                                        ff_file_acc.close()
                                        ...
                                        with open('xxAUF_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+celeb+' - Add-On-Card.txt'+'.txt', 'a') as ff_addonfile_acc:
                                            ff_addonfile_acc.write(file_credit_card_ff_acc_addon+file_credit_card_ff_acc_2_addon+file_credit_card_ff_acc_3_addon+'|Add-On|'+exp_date_acc_ff+'\n')
                                        ff_addonfile_acc.close()
                                ...
                                if logo_acc != '306':
                                    ...
                                    if ((c_bin_acc == '465523_1' and card_holder_type_acc=='1') or c_bin_acc == '457036'):
                                        ...
                                        if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                                            if mask_pan_acc not in filecontents:
                                                with open('xxAUC_PP_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_'+'EM.txt', 'a') as pp_file:
                                                ...
                                                if product != 'Zenith_Plus':
                                                    with open('xxAUC_PP_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product).replace('AU_BANK_LIT_CREDIT_CARD','Lit')+'_MIS.txt', 'a') as pp_file:
    ...
    # =============================================================================
            ...
            for f in os.listdir(path):
                ...
                if os.path.isfile(fpath) and fpath.endswith(ext):
                    ...
                    name='AUC_'+ptime_all+'---'+str(s_no) +'+'+str(total_pp_count)
            ...
            excel_files = glob.glob(os.path.join(current_directory, '*FF*.xlsx'))
            ...
            with open('config/Output_file_location.csv','r') as file:
                ...
                for f in files:
                    if f.__contains__('Priority_Pass_Data'):
                        # target_dir = pp_location
                        os.makedirs(pp_location, exist_ok=True)
                        shutil.copy(f, pp_location)
                    else:
                        # target_dir = 'D:/BANKING/AUF CREDIT/AUF_CREDIT_CUSTOMER'
            ...
            for f in os.listdir(path):
                ...
                if os.path.isfile(fpath) and (fpath.endswith('xlsx') or fpath.endswith('pdf') or fpath.endswith('dat')or fpath.endswith('csv')or fpath.endswith('txt') or fpath.endswith('.log')):
                    # time = datetime.fromtimestamp(os.path.getctime(fpath)).strftime("%d-%m-%Y-%H%M%S---"+str(qty))
                    # time = datetime.datetime.fromtimestamp(os.path.getctime(fpath)).strftime(ptime_all+str(qty).rjust(4,'0'))
                    
                    name='AUF_CREDIT_FF_MIS_'+ptime_all+'--'+str(s_no) +'+'+str(total_pp_count).rjust(4,'0')
                    os.makedirs(os.path.join(path, name), exist_ok=True)
                    os.replace(fpath, os.path.join(path, name, f))
