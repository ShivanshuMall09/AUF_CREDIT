...
try:
    print("AUF_CREDIT_ProcessV.17.1.23.13.exe running!!!!")
...
#=============================================File-Prcocessing starts=============================================   
    ...
    # =============================================================================
                                ...
                                if product == 'Zenith_Plus' or product == 'Zenith_Plus_RuPay':
    ...
    # =============================================================================
            ...
            for f in os.listdir(path):
                ...
                if os.path.isfile(fpath) and (fpath.endswith(('xlsx', 'pdf', 'dat', 'csv', 'txt', 'log','xls'))):              
                    name='AUF_CREDIT_FF_MIS_'+ptime_all+'--'+str(s_no) +'+'+str(total_pp_count)
                    os.makedirs(os.path.join(path, name), exist_ok=True)
...
# =============================================================================
#                 if os.path.isfile(fpath) and (fpath.endswith('xlsx') or \
#                                               fpath.endswith('pdf') or fpath.endswith('dat')or fpath.endswith('csv')or\
#                                                   fpath.endswith('txt') or fpath.endswith('.log')):                
