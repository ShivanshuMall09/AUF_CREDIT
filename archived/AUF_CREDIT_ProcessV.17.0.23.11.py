...
try:
    print("AUF_CREDIT_ProcessV.17.1.23.9.exe running!!!!")
...
#=============================================File-Prcocessing starts=============================================   
    ...
    # =============================================================================
                                ...
                                if logo_acc != '306':
                                    if ((c_bin_acc == '465523_1' and card_holder_type_acc=='1') or c_bin_acc == '457036' and logo_acc == '402'):
                                    ...
                                    if ((c_bin_acc == '465523_1' and card_holder_type_acc=='1') or c_bin_acc == '457036' and logo_acc == '402'):
                                        if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                                            ...
                                            elif c_bin_acc == '457036' and logo_acc == '402':#Zenith cards
                                                try:
                                ...
                                if card_holder_type_acc == '1':
                                    ...
                                    with open('xxAUF_Credit_Scanning_File.txt', 'a') as ff_file_Scan:
                                        ff_file_Scan.write(allocation_data_primary+'\n')
                                    ff_file_Scan.close()
                                    ...
                                    with open('xxAUF_Credit_Scanning_File.txt', 'a') as ff_file_Scan:
                                        ff_file_Scan.write(allocation_data_addon+'\n')
                                    ff_file_Scan.close()
    ...
    # =============================================================================
            ...
            df.to_excel('AUF_CREDIT_SCANNING_FILE_'+str(ptime[0:10]) +'--'+str(s_no) +'+'+str(total_pp_count)+'.xlsx', 'Sheet1', index=False)
            ...
            ptx = PrettyTable()
            ptx.field_names = ["Bin", "Artwork No.","JB No.", "EMBOSS Filename","Qty", "Job setup", "Printing method - Front/Back","Chip Name"]
                    ...
                    for data in datas[1:]:
                        ...
                        if (bin_num == key[8:14] and job_setup_batch == job_setup and  art_work_batch == art_work or file_name_batch in key):
                            ...
                            with open('AUF_CREDIT_BATCHCARD_FILE.csv','a') as out_file:
                                out_file.write(bin_num+'|'+job_setup_batch+'|'+key+'|'+str(value)+'|'+logo_batch+'|'+art_work_batch+'|'+printing_front+'|'+ribbon_front+'|'+printing_back+'|'+ribbon_back+'|'+''+'\n')
                            break
            ...
            with open('AUF_CREDIT_BATCHCARD_FILE.csv','r') as in_file, open('AUF_CREDIT_BATCHCARD_'+ptime[0:10]+'_'+str(sum(names.values()))+'.TXT','a') as output_file:
                ...
                output_file.write('BIN|JOB SETUP|FILE NAME|Quantity|LOGO|ARTWORK NO.|Printing Front|Ribbon Front|Printing Back|Ribbon Back|Card Action\n')
                sn = 0
                for line in contents:
                    sn+=1
            ...
            df.to_excel('AUF_CREDIT_BATCHCARD_'+ptime[0:10]+'_'+str(sum(names.values()))+'.xlsx', 'Sheet1', index=False)       
            ...
            excel_files = glob.glob(os.path.join(current_directory, '*FF*.xlsx')) + glob.glob(os.path.join(current_directory, '*PP*.xlsx')) + glob.glob(os.path.join(current_directory, '*Scan*.xlsx'))
