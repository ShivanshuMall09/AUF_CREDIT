...
try:
    print("AUF_CREDIT_ProcessV.17.1.23.1.exe running!!!!")
...
#=============================================File-Prcocessing starts=============================================   
    ...
    # =============================================================================
            ...
            for f in os.listdir(path):
                ...
                if os.path.isfile(fpath) and (fpath.endswith('xlsx') or fpath.endswith('pdf') or fpath.endswith('dat')or fpath.endswith('csv')or fpath.endswith('txt')):
