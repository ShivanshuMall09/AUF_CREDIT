...
AUF_CREDIT_ProcessV.16.0.6.py:20-10-2023[Zenith plus issue is resolve ]
                    ...
                    with open(fname) as infile:
                        for line in infile:
                            ...
                            with open('AUC_EM_account.txt', 'a') as em_file:
                                em_file.write(file_credit_card_em)   #Replacing Embo with dots to spaces requested by Aamir sir
