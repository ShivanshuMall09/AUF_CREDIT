...
@author: rajeev.jadaun
      AUF_CREDIT_ProcessV.15.4.4.py:16-02-2023[awb allocation for new add-on only ]                      
...
#=============================================Fees-Logic=============================================                
 ...
 #=============================================File-Prcocessing starts=============================================   
        ...
        with open("config/File_DupeCheck.csv",'r') as dupecheck_file,open(f"AUF_File_DupeCheck_{ptime_1}.csv",'a') as dupecheck_file_cust:
            ...
            filenames = [Type[1] for Type in Types]
            
            for fn in file_name:
                if fn in filenames:
                    print("Duplicate files found : "+fn)
                    dupecheck_file_cust.write("Duplicate files found : "+fn.rstrip()+"\n")
