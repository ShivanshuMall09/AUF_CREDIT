...
try:
   ...
   ################################text file are created #################################### 
    ...
    bdfin.close()
    bdfout.close()
    os.remove('config/BD_AWB_USING.txt')#Deleting extra file
    ...
    dtfin.close()
    dtfout.close()
    os.remove('config/DL_AWB_USING.txt')#Deleting extra file
    ...
    ipfout.close()
    ipfout.close()
    os.remove('config/IP_AWB_USING.txt')#Deleting extra file
