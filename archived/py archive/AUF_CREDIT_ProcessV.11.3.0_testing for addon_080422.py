...
# -----------------------------------------------------------------------------------------
                    ...
                    ref_number = customer_id_acc[2:]+card_holder_name_acc[0:4].upper(
                    )+j_day[4:7]+j_day[0:4]+str(s_no)
                ...
                ps1 = account_number_acc+'|'+card_type+'|'+account_number_acc+'|'+mask_pan_acc+'|'+mailer_name_acc+'|'+card_action+'|'+c_bin_f_acc+'|'+logo_acc+'|' +gender_code_acc+'|'+varient+'|' +str(awb_number)+'|'+routing_code+'|'+print_card_holder_name_acc +'|'+joining_fees+'|'+annual_fees +'|'+str(jdtodatestd(date_acc))
                ...
                with open('xxAUC_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+'_'+str(ptime)+'.txt', 'a') as ff_file_acc:
                    ff_file_acc.write(
                        file_credit_card_ff_acc + str(awb_number)+'|'+routing_code+'|'+courier+'\n')
                ff_file_acc.close()
                ...
                if courier == 'Speedpost':
                    with open('xxxAUC_Credit_IndiaPost_Courier_Connection_Report_.txt', 'a') as ff_ip_acc:
                        # ff_ip_acc.write(indianpost_courier_1+indianpost_courier_2+'\n')
                        ff_ip_acc.write(indianpost_courier+'\n')
                    ff_ip_acc.close()
                elif courier == 'DELHIVERY':
                    with open('xxxAUC_Credit_Delhivery_Courier_Connection_Report_.txt', 'a') as ff_dl_acc:
                        ff_dl_acc.write(delhivery_courier+'\n')
                    ff_dl_acc.close()
                elif courier == 'BLUEDART':
                    with open('xxxAUC_Credit_Bluedart_Courier_Connection_Report_.txt', 'a') as ff_bd_acc:
                ...
                if card_holder_type_acc == '1':
                    with open('xxAUC_FF_MIS_test_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+'.txt', 'a') as ff_file_acc:
                    ...
                    with open('xxAUC_FF_MIS_test_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+' - Add-On-Card.txt', 'a') as ff_addonfile_acc:
                    ...
                    if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                        if mask_pan_acc not in filecontents:
                            with open('xxAUC_PP_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+product+'_'+str(ptime)+'.csv', 'a') as pp_file:
                                pp_file.write(
                                    'Sr. No|Account Number|Ref no.|Primary Card number|Customer Name|PP  Card No_Primary|Expiry Date|Variant|Logo|Gender|AWB. No.|Courier\n')
                                pp_file.write(
                                    file_credit_card_ff_acc_new+'|' + str(awb_number)+'|'+courier+'|'+routing_code+'\n')
                                count += 1
                            pp_file.close()
...
uniqlines = set(open('del_SecondaryCard1.dat').readlines())
bar = open('SecondaryCard1_details_'+str(ptime) +
           '.txt', 'w').writelines(set(uniqlines))


my_file1 = Path('xxAUC_FF_MIS_test_B457036_L401_G1_Zenith_.txt')
my_file2 = Path('xxAUC_FF_MIS_test_B457036_L401_G2_Zenith_.txt')
my_file3 = Path('xxAUC_FF_MIS_test_B465523_L301_G1_Vetta_.txt')
my_file4 = Path('xxAUC_FF_MIS_test_B465523_L301_G2_Vetta_.txt')
my_file5 = Path('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_.txt')
my_file6 = Path('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female.txt')
my_file7 = Path('xxAUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_.txt')
my_file8 = Path('xxAUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_.txt')
my_file9 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_.txt')
my_file10 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Female.txt')
my_file11 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male.txt')
my_file12 = Path('xxAUC_FF_MIS_test_B457036_L401_G1_Zenith_ - Add-On-Card.txt')
my_file13 = Path('xxAUC_FF_MIS_test_B457036_L401_G2_Zenith_ - Add-On-Card.txt')
my_file14 = Path('xxAUC_FF_MIS_test_B465523_L301_G1_Vetta_ - Add-On-Card.txt')
my_file15 = Path('xxAUC_FF_MIS_test_B465523_L301_G2_Vetta_ - Add-On-Card.txt')
my_file16 = Path('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_ - Add-On-Card.txt')
my_file17 = Path(
    'xxAUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female - Add-On-Card.txt')
my_file18 = Path(
    'xxAUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_ - Add-On-Card.txt')
my_file19 = Path(
    'xxAUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_ - Add-On-Card.txt')
my_file20 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_ - Add-On-Card.txt')
my_file21 = Path(
    'xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Female - Add-On-Card.txt')
my_file22 = Path(
    'xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male - Add-On-Card.txt')
my_file23 = Path('xxxAUC_Credit_IndiaPost_Courier_Connection_Report_.txt')
my_file24 = Path('xxxAUC_Credit_Delhivery_Courier_Connection_Report_.txt')
my_file25 = Path('xxxAUC_Credit_Bluedart_Courier_Connection_Report_.txt')


if my_file1.is_file():
    with open('xxAUC_FF_MIS_test_B457036_L401_G1_Zenith_.txt', "r") as ff, open('AUC_FF_MIS_test_B457036_L401_G1_Zenith_.txt', "w") as foutfile:
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B457036_L401_G1_Zenith_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B457036_L401_G1_Zenith_' +str(s_no_1)+'.xlsx', 'Sheet1', index=False)

if my_file2.is_file():
    with open('xxAUC_FF_MIS_test_B457036_L401_G2_Zenith_.txt', "r") as ff, open('AUC_FF_MIS_test_B457036_L401_G2_Zenith_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B457036_L401_G2_Zenith_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B457036_L401_G2_Zenith_' +str(s_no_2)+'.xlsx', 'Sheet1', index=False)

if my_file3.is_file():
    with open('xxAUC_FF_MIS_test_B465523_L301_G1_Vetta_.txt', "r") as ff, open('AUC_FF_MIS_test_B465523_L301_G1_Vetta_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B465523_L301_G1_Vetta_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B465523_L301_G1_Vetta_' +str(s_no_3)+'.xlsx', 'Sheet1', index=False)
if my_file4.is_file():
    with open('xxAUC_FF_MIS_test_B465523_L301_G2_Vetta_.txt', "r") as ff, open('AUC_FF_MIS_test_B465523_L301_G2_Vetta_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B465523_L301_G2_Vetta_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B465523_L301_G2_Vetta_' +str(s_no_4)+'.xlsx', 'Sheet1', index=False)

if my_file5.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G2_Altura_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G2_Altura_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G2_Altura_' +str(s_no_5)+'.xlsx', 'Sheet1', index=False)

if my_file6.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female' +str(s_no_6)+'.xlsx', 'Sheet1', index=False)

if my_file7.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_' +str(s_no_7)+'.xlsx', 'Sheet1', index=False)

if my_file8.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_' +str(s_no_8)+'.xlsx', 'Sheet1', index=False)

if my_file9.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G1_Altura_.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G1_Altura_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G1_Altura_' +str(s_no_9)+'.xlsx', 'Sheet1', index=False)
...
if my_file10.is_file():
    ...
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G1_Altura_.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G1_Altura_' +str(s_no_10)+'.xlsx', 'Sheet1', index=False)


if my_file11.is_file():
    with open('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male' +str(s_no_11)+'.xlsx', 'Sheet1', index=False)
...
if my_file12.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B457036_L401_G1_Zenith_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B457036_L401_G1_Zenith_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B457036_L401_G1_Zenith_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B457036_L401_G1_Zenith_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file13.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B457036_L401_G2_Zenith_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B457036_L401_G2_Zenith_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B457036_L401_G2_Zenith_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B457036_L401_G2_Zenith_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file14.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B465523_L301_G1_Vetta_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B465523_L301_G1_Vetta_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B465523_L301_G1_Vetta_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B465523_L301_G1_Vetta_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file15.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B465523_L301_G2_Vetta_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B465523_L301_G2_Vetta_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B465523_L301_G2_Vetta_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B465523_L301_G2_Vetta_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file16.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G2_Altura_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G2_Altura_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G2_Altura_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file17.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file18.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file19.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file20.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_ - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G1_Altura_ - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G1_Altura_ - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G1_Altura_' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)
...
if my_file22.is_file():
    records_list = []
    s_no = 0
    with open('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male - Add-On-Card.txt', "r") as ff, open('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male - Add-On-Card.txt', "w") as foutfile:
        foutfile.write("Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date"+'\n')
        contents = ff.readlines()
        # sorting using our custom logic
        contents.sort(key=my_sort_ff)
    ...
    bf.close()
    boutfile.close()
    df = pd.read_csv('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male - Add-On-Card.txt', sep='|', dtype=object)
    df.to_excel('AUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male' +str(s_no)+' - Add-On-Card.xlsx', 'Sheet1', index=False)

if my_file23.is_file():
    records_list = []
    s_no = 0
    with open('xxxAUC_Credit_IndiaPost_Courier_Connection_Report_.txt', "r") as ff, open('AUC_Credit_IndiaPost_Courier_Connection_Report_.txt', "w") as foutfile:
        foutfile.write(
    ...
    ff.close()
    foutfile.close()
    df = pd.read_csv('AUC_Credit_IndiaPost_Courier_Connection_Report_.txt', sep='|', dtype=object)
    df.to_excel('AUC_Credit_IndiaPost_Courier_Connection_Report_' +str(s_no)+'_'+str(ptime)+'.xlsx', 'Sheet1', index=False)
'''
if my_file24.is_file():
    records_list=[]
    s_no=0
    with open('xxxAUC_Credit_Delhivery_Courier_Connection_Report_.txt',"r") as ff, open('AUC_Credit_Delhivery_Courier_Connection_Report_.csv',"w") as foutfile:
    ...
    ff.close()
    foutfile.close()
    df = pd.read_csv('AUC_Credit_Delhivery_Courier_Connection_Report_.csv', sep='|', dtype=object)
    df.to_excel('AUC_Credit_Delhivery_Courier_Connection_Report_'+str(s_no)+'_'+str(ptime)+'.xlsx', 'Sheet1',index=False)
'''
if my_file25.is_file():
    records_list = []
    s_no = 0
    with open('xxxAUC_Credit_Bluedart_Courier_Connection_Report_.txt', "r") as ff, open('AUC_Credit_Bluedart_Courier_Connection_Report_.txt', "w") as foutfile:
        foutfile.write(
    ...
    ff.close()
    foutfile.close()
    df = pd.read_csv('AUC_Credit_Bluedart_Courier_Connection_Report_.txt', sep='|', dtype=object)
    df.to_excel('AUC_Credit_Bluedart_Courier_Connection_Report_' +str(s_no)+'_'+str(ptime)+'.xlsx', 'Sheet1', index=False)
