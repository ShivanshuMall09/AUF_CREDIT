...
#-----------------------------------------------------------------------------------------
                    ...
                    file_credit_card_ff_acc_test_3_addon=card_action+'|'+'|'+'|'+'|'+c_bin_f_acc+'|'+logo_acc+'|'+gender_code_acc+'|'+varient+'|'+mailer_address1_acc+'|'+mailer_address2_acc+'|'+mailer_address3_acc+'|'+mailer_address4_acc+'|'+mailer_city_acc+'|'+mailer_state_code_acc+'|'+mailer_postal_code_acc+'|'+mailer_mob_acc+'|'+customer_id_acc+'|'+cr_card_limit+'|'+billing_cycle+'|'+superscript+'|'+print_card_holder_name_acc+'|'+joining_fees+'|'+annual_fees+'|'+str(jdtodatestd(date_acc))
                ...
                if card_holder_type_acc == '1':
                    with open('xxAUC_FF_MIS_test_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+'.txt', 'a') as ff_file_acc:
                        ...
                        ff_file_acc.write(file_credit_card_ff_acc_test_primary+file_credit_card_ff_acc_test_2_primary+file_credit_card_ff_acc_test_3_primary+'\n')
                    ...
                    with open('xxAUC_FF_MIS_test_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+' - Add-On-Card.txt', 'a') as ff_addonfile_acc:
                            ...
                            #ff_file_accm.write(header)
                        #ff_file_acc.write('Sr. No|Account Number|Primary Card number|Customer Name|Add-on Card 1|Add-on Card 2|Add-on Card 3|Add-on Card 4|PP  Card No_Primary|PP  Card No_Addon1|PP  Card No_Addon2|PP  Card No_Addon3|Ref no.|AWB. No.|Courier|Courier Code|Card Action|Primary Count|Add-on Count|Total Cards|Bin|Logo|Gender Code|Varient|Address Line 1|Address Line 2|Address Line 3|Address Line 4|City|State Code|Postal Code|Mobile Number|Cust Unique ID|Credit Limit|Statement Date |Extention|Embo_Name|Joining Fees|Annual Fees|Card Issuance Date\n')
                        ff_addonfile_acc.write(file_credit_card_ff_acc_test_primary+file_credit_card_ff_acc_test_2_primary+file_credit_card_ff_acc_test_3_primary+'\n')
...
for idx, val in enumerate(ps1_list):
            ...
            if ps_list[idx][17:29] == 'Add-on  Card':
                s_acc_card_count1.append(str(ps1_list[idx])+'|'+str(ps1_list.count(ps1_list[idx])))
'''
with open('PrimaryCard_detail_'+str(ptime)+'.txt', 'w') as ps_d:
  ps_d.writelines(["%s\n" % item  for item in p_acc_card_count])
ps_d.close()
...
bar = open('SecondaryCard1_details_'+str(ptime)+'.txt', 'w').writelines(set(uniqlines))
...
my_file17= Path('xxAUC_FF_MIS_test_B466505_L101_G2_Altura_C_Female - Add-On-Card.txt')
my_file18= Path('xxAUC_FF_MIS_test_B466505_L102_G1_AlturaPlusBlue_ - Add-On-Card.txt')
my_file19= Path('xxAUC_FF_MIS_test_B466505_L102_G2_AlturaPlusRuby_ - Add-On-Card.txt')
my_file20= Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_ - Add-On-Card.txt')
my_file21 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Female - Add-On-Card.txt')
my_file22 = Path('xxAUC_FF_MIS_test_B466505_L101_G1_Altura_C_Male - Add-On-Card.txt')
