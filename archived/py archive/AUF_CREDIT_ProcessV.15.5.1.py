...
@author: rajeev.jadaun
      AUF_CREDIT_ProcessV.15.5.1.py:18-03-2023[assigning plastic code ‘2’ as “Altura Celib. Female” product, but now this plastic code will be assigned to “Altura Base”. ]  
...
#=============================================File-Prcocessing starts=============================================   
    ...
    # =============================================================================
                            ...
                            #as the the cr change 15.5.1(18032023)
                            if c_bin_acc == '466505'  and  logo_acc == '101' and plastic_id == '0000000003':
                                celeb = ''
                            ...
                            if c_bin_acc == '466505'  and  logo_acc == '101': 
                                ...
                                if plastic_id == '          ':
                                    ...
                                    varient = 'Altura'   #as per the change request 15.5.1
                                else:
                                    varient ='Not Found'
