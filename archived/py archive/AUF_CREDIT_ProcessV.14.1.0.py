...
# -----------------------------------------------------------------------------------------
                ...
                if ((c_bin_acc == '465523' and card_holder_type_acc=='1') or c_bin_acc == '457036'):
                    if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                        ...
                        pp_cardnumber_acc=pp_cardnumber_acc
                        pp_count = '1'
                    else:
                        pp_cardnumber_acc=''
                else:
                ...
                if ((card_holder_type_acc == '1') and (card_action_code=='3' or card_action_code== 'L')):
                    with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+'.txt', 'a') as ff_file_acc:
                    ...
                    with open('xxAUF_Replace_FF_MIS_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+' - Add-On-Card.txt', 'a') as ff_addonfile_acc:
                    ...
                    with open('xxAUC_EM_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+str(product)+'_'+celeb+'_AddOn_Replace.txt', 'a') as em_file_acc:
                        em_file_acc.write(file_credit_card_em_acc+courier+'\n')
                    em_file_acc.close()
                ...
                if ((c_bin_acc == '465523' and card_holder_type_acc=='1') or c_bin_acc == '457036'):
                    if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                        if mask_pan_acc not in filecontents:
                            with open('xxAUC_PP_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+product+'_'+'EM.txt', 'a') as pp_file:
                ...
                if ((c_bin_acc == '465523' and card_holder_type_acc=='1') or c_bin_acc == '457036'):
                    if (card_action_code == '1' or card_action_code == '2' or card_action_code == '7' or card_action_code == 'A'):
                        if mask_pan_acc not in filecontents:
                            with open('xxAUC_PP_B'+str(c_bin_acc)+'_L'+str(logo_acc)+'_G'+str(gender_code_acc)+'_'+product+'_MIS.txt', 'a') as pp_file:
...
def excel_convertor(name_ff):
    ...
    if Path(name_ff).is_file():
        ...
        boutfile.close()
        '''
        df = pd.read_csv(name_ff[2:], sep='|', dtype=object)
...
def pp_excel_convertor(name_ff,name_embo):
    ext='.txt'
    if Path(name_ff+ext).is_file():
        ...
        df.to_excel(name_ff[2:]+ '_'+str(s_no)+'.xlsx', 'Sheet1', index=False) 
        
        os.remove(name_ff+ext)
        os.remove(name_embo+ext)


ff_filename = glob.glob("*FF_MIS_B*")
...
for key, value in names.items():
    if key[4:41] == 'EM_B457036_L401_G1_Zenith_CII_Young_Indian':
        art_work = 'V00884'
