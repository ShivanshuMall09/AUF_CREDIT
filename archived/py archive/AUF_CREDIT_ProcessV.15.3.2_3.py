      ...
      #-----------------------PP DUP CHECK------------------------------------------------------------   
        ...
        def excel_convertor(name_ff):
            ...
            if Path(name_ff).is_file():
                ...
                df.to_excel(name_ff[2:-4]+'--'+ str(s_no)+'.xlsx', 'Sheet1', index=False)
        ...
        def pp_excel_convertor(pp_name_ff):
            ...
            if Path(pp_name_ff).is_file():
                ...
                df.to_excel(pp_name_ff[2:-4]+ '--'+str(s_no) +'.xlsx', 'Sheet1', index=False) 
